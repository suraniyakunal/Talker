        ...
        <form onSubmit={loginHandler} className="space-y-6 px-4">
          <div>
            <input
              ...
              className="w-full normal-text light-black px-3 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
            />
          </div>
          <div>
            <input
          ...
          <button
            required
            type="submit"
            className="w-full p-2 rounded-lg text-gray-900 hover:bg-gray-600 bg-gray-300 font-semibold transition"
          >
            Login
          </button>
        </form>
