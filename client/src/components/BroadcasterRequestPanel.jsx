// BroadcasterRequestPanel — floating panel for host to approve/deny raise-hand requests
...
/**
 * BroadcasterRequestPanel
 * Props:
 *   requests  – Array<{ user: { _id, username }, roomId }>
 *   onApprove – (user) => void
 *   onDeny    – (user) => void
 */
const BroadcasterRequestPanel = ({ requests = [], onApprove, onDeny }) => {
...
export default BroadcasterRequestPanel
